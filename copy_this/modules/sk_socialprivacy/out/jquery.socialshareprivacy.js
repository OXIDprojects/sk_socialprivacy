    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '/modules/sk_socialprivacy/out/images/dummy_facebook.png',
                ...
                'twitter' : {
                    'status'            : 'on', 
                    'dummy_img'         : '/modules/sk_socialprivacy/out/images/dummy_twitter.png',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '/modules/sk_socialprivacy/out/images/dummy_gplus.png',
                ...
                'pinterest' : {
                    'status'			: 'on',
                    'dummy_img'			: '/modules/sk_socialprivacy/out/images/dummy_pinterest.png',
            ...
            'cookie_expires'    : '365',
            'css_path'          : '/modules/sk_socialprivacy/out/socialshareprivacy.css',
            'uri'               : getURI
        };
            ...
            //
                ...
                $("li.pinterest div.pinterest img,li.pinterest span.switch", context).live("click", function () {
                    if ($container_pinterest.find("span.switch").hasClass("off")) {
                        ...
                        $container_pinterest.find("img.pinterest_dummy").replaceWith(pinterest_button);
                    } else {
